 ...
 * @LastEditors: mingwei
 * @LastEditTime: 2022-05-26 15:44:16
 * @FilePath: /hezong/frontend/ms-hezong/src/pages/users/login/index.tsx
 * @Description:
 */
  ...
  const registerForm = () => {
    return (
      <Form onFinish={handleSubmit} labelCol={{ span: 3 }}>
        <Form.Item rules={[{ required: true, message: '账号不能为空' }]} className='form-item' name='username' label='账号'>
